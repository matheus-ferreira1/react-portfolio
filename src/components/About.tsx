...
const About: FC<AboutProps> = ({}) => {
  return (
    <article className="flex flex-col justify-center items-center max-w-4xl px-10 md:mx-auto py-11">
      ...
      <p className="mt-4 font-thin text-center leading-relaxed">
        ...
        problemas. Adoro a sensação de finalmente encontrar uma solução para um
        problema Atualmente curso Análise e Desenvolvimento de Sistemas e atuo
        como desenvolvedor full-stack com Delphi, PHP, Angular, SQL Server e
